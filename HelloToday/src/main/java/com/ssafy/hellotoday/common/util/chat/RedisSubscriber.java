...
public class RedisSubscriber implements MessageListener {
    ...
    public void onMessage(Message message, byte[] pattern) {
        try {
            ...
            ChatMessage roomMessage = objectMapper.readValue(publishedMessage, ChatMessage.class);
            messagingTemplate.convertAndSend("/sub/" + roomMessage.getRoomId(), roomMessage);
        } catch (Exception e) {
