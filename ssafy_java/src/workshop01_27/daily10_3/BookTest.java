...
import ssafy_java.workshop06.IBookManager;
...
//		Book m =(Book) new Magazine("00002", "c++", "ssafy", "ssafy", 15000, "월간 C++", 2023, 1);
		...
		while (true) {
			...
			int id = 0;
			System.out.println("1:입력 2:수정 3:삭제 4:리스트 5:조회 6:종료");
			System.out.println("***********************************************");
			...
			case 1: {
				...
				man.insert(new Book(isbn, title, author, publisher, price, desc));
				break;
			}
			case 2: {
				System.out.println("isbn을 입력하시오");
				...
				man.update(new Book(isbn, title, author, publisher, price, desc));
				break;
			}
			case 3:{
				System.out.println("isbn을 입력하시오");
